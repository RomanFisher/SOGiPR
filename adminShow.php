        ...
        <div class="container mt-4">
            ...
            $adm = $data->fetchAll();
               ...
               { 
                    ...
                    $admins= new Admin($ad['name'],$ad['surname'],$ad['poB'],$ad['id'],$ad['login'],$ad['password'],$ad['photo'],$ad['numPhon']);
                ...
                <div class="main">
                    ...
                    <div class="row searched">
                        <div class="col-md-6">
                            <div class="image">
                                <img src="/img/admin/<?php echo $admins->photo;?>" alt="">
                            </div>
                        </div>
    
                        <div class="col-md-6">
                            <div class="title">
                                <h3 name="responsed_film" id="responsed_film" > <?php $admins->PrintNameSur(); ?>  </h3>
                                <p> <?php echo "Адмін ID : ".$admins->id; ?> </p>
                                <p> Телефон для зв'язку :  <?php echo $admins->tel; ?> </p>
                            </div>
                           
                        </div>
                        <a class="btn btn-success btn-sm" href="updateAdmin.php?id=<?=$ad['id']?>">Оновити</a>
                        <a class="btn btn-danger btn-sm" href="delAdmin.php?id=<?=$ad['id']?>">Видалити</a>
                        <hr>
                    </div>
                    <br>
                </div>
